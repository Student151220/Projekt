  ...
  <body>
    ...
    <div class="content">
      <div class="col-md-12" style="padding-top: 30px;">
        <div class="tytul_podstrony">Wszystkie książki</div><div class="clear"></div> 
        <?php
          echo "<hr/>";
          ...
          if ($rezultat1 = @$connection -> query($sql1)) {
            ...
            if ($ilosc == 0) {
              ...
              while($row1 = mysqli_fetch_row($rezultat1)) {
                ...
                $sql5 = "SELECT * FROM rezerwacja WHERE id_ksiazki=$idek AND id_uzytkownika=$sessionID";
                $rezultat5 = @$connection -> query($sql5);
                $row5 = mysqli_fetch_row($rezultat5);
                $ilosc5 = $rezultat5 -> num_rows;
                if ($ilosc5 == 0) {
                  echo "<td><a href='rezerwuj-ksiazke.php?id_ksiazki=$idek&id_uzytkownika=$sessionID'><div class='dodajakt'>Rezerwuj ksiażkę</div></a></td>";
                }
                else {
                    echo "<td><div class='edytuj-news'>Zarezerwowano</div></td>";
                }
                echo "</tr>";
              }
              echo "</table>";
