    ...
    <body>
        ...
        <div class="content">
            <div class="col-md-12" style="padding-top: 30px;">
                <div class="tytul_podstrony">Wydawnictwa</div><a href="dodaj-wydawnictwo.php"><div class="dodajakt">Dodaj wydawnictwo</div></a><div class="clear"></div> <hr/>
                <?php 
                    if (isset($_SESSION['info_dodawanie_newsa'])) echo $_SESSION['info_dodawanie_newsa'];
                    $sql1 = "SELECT wydawnictwo, id_wydawnictwa FROM wydawnictwo";
                    if ($rezultat1 = @$connection -> query($sql1)) {
                        $ilosc = $rezultat1 -> num_rows;
                        if ($ilosc == 0) {
                            echo "Brak wydawnictw.";
                        }
                        else {
