...
require_once('../connect.php');
    ...
    if (isset($_POST['gatunek'])) {
        ...
        if ($connection -> connect_errno != 0) {
            ...
            $sql1 = "INSERT INTO gatunek VALUES (NULL, '$gatunek')";
            if ($connection->query($sql1)) 
            {
                header('Location: gatunki.php ');
    ...
    <body>
        ...
        <div class="content">
            <div class="col-md-12" style="padding-top: 30px;">
                <div class="podtytul"> Dodaj nowy gatunek </div>
                <form method="post">
                    <input name="gatunek" type="text" placeholder="Nazwa gatunku" required/> <br/><br/>
                    <input type="submit" value="Dodaj" />
                </form>
                <br/><br/>
                <p> Gatunki: </p>
                <?php
                    $sql0 = "SELECT * FROM gatunek";
